  ...
  <div id="slider">
    <div class="window" @mouseover="stop" @mouseleave="play">
      ...
      <!-- <ul class="container"> -->
        ...
        <!-- <li>
          <img :style="{width:imgWidth+'px'}" :src="sliders[0].src" alt="">
        
        </li> -->
         <li  v-for="(item, index) in sliders" :key="index">
          <img class="lbt" :style="{width:imgWidth+'px'}" :src="item.src" alt="">
        </li>
        <!-- <li>
          <img :style="{width:imgWidth+'px'}" :src="sliders[0].src" alt="">
        </li>  -->
      ...
      <ul class="direction">
        <li class="left" @click="move(1903, 1, speed)">
        ...
        <li class="right" @click="move(1903, -1, speed)">
...
export default {
  ...
  mounted() {
    this.init()
    axios.get('http://localhost:3000/tp').then(res=>{
  ...
  methods:{
    ...
    move(offset, direction, speed) {
      ...
      direction === -1 ? this.currentIndex += offset/1903 : this.currentIndex -= offset/1903
    ...
    animate(des, direc, speed) {
      ...
      this.temp = window.setInterval(() => {
        if ((direc === -1 && des < this.distance) || (direc === 1 && des > this.distance)) {
          ...
          window.clearInterval(this.temp)
          this.distance = des
          if (des < -5709) this.distance = 0
          if (des > 0) this.distance = -5709
        }
      }, 20)
    },
    jump(index) {
      const direction = index - this.currentIndex >= 0 ? -1 : 1;
      const offset = Math.abs(index - this.currentIndex) * 1903;
